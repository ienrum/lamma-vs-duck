...
const Layout = ({ children, params }: { children: React.ReactNode; params: { gameId: string } }) => {
  return (
    <>
      <Head>
        ...
        <meta property="og:url" content={`https://lamma-vs-duck.vercel.app/result/${params.gameId}`} />
        ...
        <meta property="twitter:url" content={`https://lamma-vs-duck.vercel.app/result/${params.gameId}`} />
